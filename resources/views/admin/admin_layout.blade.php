...
<head>
    ...
    <title>Home</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('adminlayout/assets/images/logo-icon-removebg-preview.png') }}" />
    <!-- Custom CSS -->
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{ route('home') }}">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('adminlayout/assets/images/favicon.png') }}" alt="homepage" class="light-logo"
                                width="25" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic"
                               href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{ '/storage/app/public/W.jpg' }}" alt="user" class="rounded-circle" width="31" />
                                <span class="ms-2">{{ Auth::guard('admin')->user()->QTV_TEN ?? 'Admin' }}</span>
                            </a>
