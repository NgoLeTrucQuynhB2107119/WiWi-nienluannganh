...
<div class="container mt-4">
    <h2 class="mb-4">Sửa Dịch Vụ Sức Khỏe</h2>

    <form action="{{ route('admin.serviceB.update', $dichvu->DV_MA) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="DV_THOIGIAN_THUCHIEN" name="DV_THOIGIAN_THUCHIEN" value="{{ $dichvu->DV_THOIGIAN_THUCHIEN }}" required>
        </div>
        <div class="form-group">
